...
>  read one a month, and I feel myself  
>  infinitely the happier for it."  
>                           --- Thomas Jefferson

Single payment notes are loans which obligate the borrower to repay the principal
borrowed plus the interest charged by the lender in one payment that is due on a
date specified in the note.

## Single Payment Note Request Data Object Field Definition

**Example - Request Envelope for SinglePmt Module**
...
The fields of the `Data` object supported by a SinglePmt module request are
...
**Example - Response Envelope for SinglePmt Module**
...
| :--- | :---: | ---: |
| [Loan Module](module-loan.md) | [SCEJSON Reference Manual](README.md) | [APR Calculation & Verification Module](module-apr.md) |
